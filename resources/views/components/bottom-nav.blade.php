...
<nav class="bottom-nav sm:hidden">
    ...
    <a href="{{ route('inspections.create') }}" 
       class="bottom-nav-item {{ request()->routeIs('inspections.create') ? 'active' : '' }}">
        <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('inspections.history') }}" 
       class="bottom-nav-item {{ request()->routeIs('inspections.history') ? 'active' : '' }}">
        <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
