                            ...
                            @foreach($inspections as $inspection)
                                <li class="mb-4 p-4 border rounded-md">
                                    ...
                                    @if($inspection->status !== 'pending')
                                        <a href="{{ route('report.inspection.pdf', $inspection) }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mt-4 inline-block">Gerar PDF</a>
                                    @endif
                                </li>
                            @endforeach
                        </ul>
